...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row bg-[#1c2012] text-slate-100 font-nexa-style relative overflow-hidden">
            {/* Left Column: Form */}
            <div className="w-full md:w-[45%] lg:w-[40%] xl:w-[35%] flex flex-col justify-between p-8 lg:p-12 z-10 bg-[#1c2012] relative">
                ...
                <div className="flex-1 flex flex-col justify-center max-w-md w-full mx-auto">
                    <h1 className="text-4xl lg:text-5xl font-extrabold text-white mb-3">Welcome Back</h1>
                    <p className="text-slate-400 text-sm font-medium mb-10">Access your global B2B trading dashboard.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="bg-[#252a1a] border-primary/20 text-white placeholder:text-slate-600 focus:border-primary focus:ring-1 focus:ring-primary rounded-xl h-14 pl-12 pr-12 transition-all duration-300 abstract-bg"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-primary transition-colors p-1"
                                >
                        ...
                        <Button
                            type="submit"
                            className="w-full bg-primary text-[#1c2012] hover:bg-primary/90 h-14 text-base font-extrabold tracking-wide rounded-xl mt-8 transition-all hover:shadow-[0_0_20px_rgba(211,235,148,0.3)] flex items-center justify-center gap-2"
                            disabled={isLoading}
                        >
                    ...
                    <div className="mt-10 border-t border-primary/10 pt-8 text-center text-sm text-slate-400 font-medium">
                        New to our platform?{' '}
                ...
                {/* Footer Links */}
                <div className="mt-12 flex flex-wrap justify-between items-center text-[10px] text-slate-500 font-bold tracking-widest uppercase gap-4 opacity-60">
                    <p>© 2026 VERCHOOL B2B INC.</p>
